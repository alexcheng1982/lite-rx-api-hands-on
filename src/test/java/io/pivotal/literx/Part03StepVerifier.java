...
//========================================================================================
	...
	void expectSkylerJesseComplete(Flux<User> flux) {
		StepVerifier.create(flux)
                .expectNextMatches(u -> Objects.equals(u.getUsername(), "swhite"))
                .expectNextMatches(u -> Objects.equals(u.getUsername(), "jpinkman"))
                .verifyComplete();
	}
...
//========================================================================================
	...
	void expect10Elements(Flux<Long> flux) {
        Duration duration = StepVerifier.create(flux).expectNextCount(10L).verifyComplete();
...
//========================================================================================
	...
	void expect3600Elements(Supplier<Flux<Long>> supplier) {
        Duration duration = StepVerifier.withVirtualTime(supplier).thenAwait(Duration.ofSeconds(3600)).expectNextCount(3600L).verifyComplete();
        System.out.println(duration);
    }
